        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center gap-2">
              ...
              <span className="font-serif text-2xl font-bold text-[#2C241A]">
                Il Gallo
                <span className="block text-[10px] font-sans font-normal tracking-widest uppercase text-[#B8944A]">
                  Osteria
                </span>
              </span>
            </div>
            <div className="hidden md:flex items-center gap-8">
              <Link href="#menu" className="text-sm font-semibold text-[#2C241A]/70 hover:text-[#2C241A] transition">
                Menù
              </Link>
              <Link href="#vini" className="text-sm font-semibold text-[#2C241A]/70 hover:text-[#2C241A] transition">
                Vini
              </Link>
              <Link href="#recensioni" className="text-sm font-semibold text-[#2C241A]/70 hover:text-[#2C241A] transition">
                Recensioni
              </Link>
              <Link href="#chi-siamo" className="text-sm font-semibold text-[#2C241A]/70 hover:text-[#2C241A] transition">
                Chi Siamo
              </Link>
              <a
                href="tel:+390383123456"
                className="bg-[#B8944A] text-white px-6 py-2.5 rounded-full text-sm font-semibold hover:bg-[#D4B87A] transition shadow-lg shadow-[#B8944A]/25"
              >
                📞 Prenota
              </a>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="font-serif text-xl text-[#2C241A]/70 italic mb-6">
                Cucina italiana • Carne alla brace • Tradizione
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                <a
                  href="tel:+390383123456"
                  className="bg-[#2C241A] text-white px-8 py-4 rounded-full font-semibold hover:bg-[#3D3226] transition shadow-lg"
                >
                  📞 Chiama Ora
                </a>
                <a
                  href="#menu"
                  className="border-2 border-[#B8944A] text-[#2C241A] px-8 py-4 rounded-full font-semibold hover:bg-[#B8944A] hover:text-white transition"
                >
                  Scopri il menù →
                </a>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="font-serif text-4xl md:text-5xl font-bold text-[#2C241A] mb-4">
                La Nostra Osteria
              </h2>
      ...
      <section id="menu" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-[#2C241A] mb-3">
              I Nostri Classici
            </h2>
            <p className="text-[#2C241A]/60 max-w-xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 border border-[#EDE6DB] shadow-sm hover:shadow-md transition">
              ...
              <h3 className="font-serif text-2xl font-bold text-[#2C241A] mb-4 border-b-2 border-[#F5EDDD] pb-3">
                Antipasti
              </h3>
              <div className="space-y-4">
                <div className="flex justify-between items-start gap-4 pb-3 border-b border-[#EDE6DB]">
                  <div>
                    ...
                    <div className="text-sm text-[#2C241A]/50">Misto di salumi tipici e formaggi stagionati</div>
                  </div>
                  <span className="font-semibold text-[#B8944A] whitespace-nowrap">€14</span>
                </div>
                <div className="flex justify-between items-start gap-4 pb-3 border-b border-[#EDE6DB]">
                  <div>
                  ...
                  <span className="font-semibold text-[#B8944A] whitespace-nowrap">€10</span>
                </div>
                <div className="flex justify-between items-start gap-4">
                  ...
                  <span className="font-semibold text-[#B8944A] whitespace-nowrap">€16</span>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-start gap-4 pb-3 border-b border-[#EDE6DB]">
                  <div>
                    ...
                    <div className="text-sm text-[#2C241A]/50">Ravioli ripieni di ricotta e spinaci, burro e salvia</div>
                  </div>
                  <span className="font-semibold text-[#B8944A] whitespace-nowrap">€15</span>
                </div>
                <div className="flex justify-between items-start gap-4 pb-3 border-b border-[#EDE6DB]">
                  <div>
                  ...
                  <span className="font-semibold text-[#B8944A] whitespace-nowrap">€17</span>
                </div>
                <div className="flex justify-between items-start gap-4">
                  <div>
                    <div className="font-medium">Tagliatelle al tartufo</div>
                    <div className="text-sm text-[#2C241A]/50">Tagliatelle fresche, tartufo nero e burro fuso</div>
                  </div>
                  <span className="font-semibold text-[#B8944A] whitespace-nowrap">€20</span>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-start gap-4 pb-3 border-b border-[#EDE6DB]">
                  <div>
                    ...
                    <div className="text-sm text-[#2C241A]/50">Bistecca di manzo Chianina, cotta a legna</div>
                  </div>
                  <span className="font-semibold text-[#B8944A] whitespace-nowrap">€35</span>
                </div>
                <div className="flex justify-between items-start gap-4 pb-3 border-b border-[#EDE6DB]">
                  <div>
                    <div className="font-medium">Ossobuco</div>
                    <div className="text-sm text-[#2C241A]/50">Ossobuco di vitello, gremolada e risotto</div>
                  </div>
                  <span className="font-semibold text-[#B8944A] whitespace-nowrap">€22</span>
                </div>
                <div className="flex justify-between items-start gap-4">
                  <div>
                    <div className="font-medium">Grigliata mista di carne</div>
                    <div className="text-sm text-[#2C241A]/50">Tagli di manzo, maiale e salsiccia</div>
                  </div>
                  <span className="font-semibold text-[#B8944A] whitespace-nowrap">€28</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-[#FCF8F2] rounded-2xl p-8 border border-[#EDE6DB] shadow-sm">
              ...
              <p className="italic text-[#2C241A]/80 leading-relaxed mb-4">
                "Ottimo trovato benissimo. Fiorentina e un Montefalco riserva 2021: tutto Ottimo. Anche il dolce pera al vino rosso con gelato."
              </p>
            ...
            <div className="bg-[#FCF8F2] rounded-2xl p-8 border border-[#EDE6DB] shadow-sm">
              <div className="text-[#B8944A] text-xl mb-3">⭐⭐⭐⭐⭐</div>
              <p className="italic text-[#2C241A]/80 leading-relaxed mb-4">
                "Location molto carina e curata. Cibo di alta qualità. Buon rapporto qualità/prezzo. Esperienza assolutamente da ripetere."
              </p>
              <div className="font-semibold">ILKASTA - Fabio Costaldi <span className="font-normal text-sm text-[#2C241A]/50">4 mesi fa</span></div>
            </div>
            <div className="bg-[#FCF8F2] rounded-2xl p-8 border border-[#EDE6DB] shadow-sm">
              <div className="text-[#B8944A] text-xl mb-3">⭐⭐⭐⭐⭐</div>
              <p className="italic text-[#2C241A]/80 leading-relaxed mb-4">
                "Cucina italiana di livello, servizio attento e atmosfera elegante. Un ristorante che merita assolutamente una visita a Stradella."
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white rounded-2xl p-8 border border-[#EDE6DB] shadow-sm">
              ...
              <a
                href="https://www.google.com/maps?q=Via+Parea+3+Stradella"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#B8944A] font-semibold hover:underline inline-block mt-2"
              >
                Apri su Google Maps →
              </a>
            </div>
            <div className="bg-white rounded-2xl p-8 border border-[#EDE6DB] shadow-sm">
              ...
              <p className="text-[#2C241A]/60 text-sm mt-1">Chiama per prenotazioni e informazioni</p>
            </div>
            <div className="bg-white rounded-2xl p-8 border border-[#EDE6DB] shadow-sm">
              <h3 className="font-serif text-xl font-bold text-[#2C241A] mb-3">🕐 Orari</h3>
              <div className="space-y-2">
                <div className="flex justify-between text-sm border-b border-[#EDE6DB] pb-2">
                  <span>Lunedì</span>
                  <span className="text-[#2C241A]/70">12:00–14:00 / 19:30–22:00</span>
                </div>
                <div className="flex justify-between text-sm border-b border-[#EDE6DB] pb-2">
                  <span>Martedì</span>
                  <span className="text-[#2C241A]/70 font-semibold text-[#9E2A2A]">Chiuso</span>
                </div>
                <div className="flex justify-between text-sm border-b border-[#EDE6DB] pb-2">
                  <span>Mercoledì</span>
                  <span className="text-[#2C241A]/70">12:00–14:00 / 19:30–22:00</span>
          ...
          <div className="bg-[#2C241A] rounded-3xl p-12 text-center text-white shadow-xl">
            ...
            <p className="text-white/70 max-w-xl mx-auto mb-8">
              Chiamaci per prenotare o per richiedere informazioni sul menù e sugli eventi.
            </p>
            <a
              href="tel:+390383123456"
              className="bg-white text-[#2C241A] px-10 py-4 rounded-full font-semibold hover:bg-[#EDE6DB] transition shadow-lg inline-block"
            >
              📞 Chiama Ora
            </a>
            <p className="text-white/40 text-sm mt-4">Ti rispondiamo personalmente per rendere la tua esperienza unica.</p>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-white border-t border-[#EDE6DB] py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="font-serif text-2xl font-bold text-[#2C241A]">
            🐓 Il Gallo
            <span className="block text-xs font-sans font-normal tracking-widest uppercase text-[#2C241A]/40">
              Osteria • Stradella
            </span>
          </div>
          <p className="text-[#2C241A]/50 text-sm mt-2">Via Parea, 3 • Stradella (PV) • 📞 0383 123456</p>
          <div className="flex justify-center gap-8 mt-4">
            <a href="tel:+390383123456" className="text-[#B8944A] font-medium hover:underline text-sm">
              Chiama
            </a>
            <a
              href="https://www.google.com/maps?q=Via+Parea+3+Stradella"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#B8944A] font-medium hover:underline text-sm"
            >
              Mappa
            </a>
            <a href="mailto:info@ilgallo.it" className="text-[#B8944A] font-medium hover:underline text-sm">
              Email
            </a>
          </div>
