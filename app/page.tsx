          ...
          <div className="container">
            ...
            <div className="contact-grid">
              <div className="contact-card">
                ...
                <a href="https://www.google.com/maps?q=Via+Parea+3+Stradella" target="_blank" rel="noopener">Apri su Google Maps →</a>
              </div>
              <div className="contact-card">
                <h3>📞 Contatti</h3>
        ...
        <footer className="footer">
          <div className="container">
            ...
            <div className="footer-links">
              ...
              <a href="https://www.google.com/maps?q=Via+Parea+3+Stradella" target="_blank" rel="noopener">Mappa</a>
